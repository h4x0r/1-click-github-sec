...
curl -O https://github.com/h4x0r/1-click-github-sec/releases/download/v0.6.12/install-security-controls.sh
curl -O https://github.com/h4x0r/1-click-github-sec/releases/download/v0.6.12/multiple.intoto.jsonl
